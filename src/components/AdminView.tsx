                    ...
                    <tr key={w.id} className="hover:bg-slate-950/20 transition-all">
                      ...
                      <td className="py-3 px-3">
                        <span className={`px-2 py-0.5 rounded font-black font-mono text-[9px] uppercase border ${
                          ...
                          {w.role === 'admin' ? 'Admin' : w.role === 'coordinator' ? 'Koordynator' : w.role === 'barman' ? 'Barman' : w.role === 'ofic' ? 'Kelner' : 'Zmywak'}
                        </span>
                      </td>
                      <td className="py-3 px-3 text-right flex justify-end items-center gap-2">
                        ...
                        >
                          <option value="user">Zmywak</option>
                          <option value="ofic">Kelner</option>
                          <option value="barman">Barman</option>
                          <option value="coordinator">Koordynator</option>
                          <option value="admin">Główny Admin</option>
                        </select>
                        <button
